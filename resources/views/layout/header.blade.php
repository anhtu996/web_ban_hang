			...
			<div class="pull-right beta-components space-left ov">
				...
				<div class="beta-comp">
					<div class="cart">
						...
						<div class="beta-dropdown cart-body" id="cart-info">
							@if(Session::has('cart'))

								@foreach ($cartProduct->items as $cart)
									<div class="cart-item">
										<a class="cart-item-delete" href="{{ route('del-one-cart',$cart['item']['id']) }}"><i class="fa fa-times"></i>		
										</a>
										<div class="media">
											<a class="pull-left" href="#"><img src="image/product/{{ $cart['item']['image'] }}" height="50px" alt=""></a>
								...
								<div class="cart-caption">
									<div class="cart-total text-right">Tổng tiền: <span class="cart-total-value">{{ number_format($cartProduct->totalPrice) }}</span></div>
									<div class="clearfix"></div>
				...
				<ul class="l-inline ov">
					...
					<li><a href="#">Sản phẩm</a>
						...
						@foreach ($listMenu as $list)
							<li><a href="product-type/{{ $list->id }}">{{ $list->name }}</a></li>
						@endforeach
						</ul>
					</li>
